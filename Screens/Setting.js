    ...
    return (
        <View style={[styles.container]}>
            ...
            <View style={[styles.logoutContainer]}>
                <TouchableOpacity style={[styles.option ,{flexDirection:"row",marginLeft:"5%"}]}>
                    <Ionicons name="exit-outline" size={22} color="#FF6969" />
                    <Text style={[styles.optionText ,{color:"#FF6969"}]}>Logout</Text>
                </TouchableOpacity>
            </View>
        </View>
    )
